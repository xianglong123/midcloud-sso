 ...
 *
 * <p>The default implementation is {@link com.cmft.core.path.impl.AntPathMatcher}, supporting the Ant-style pattern syntax.		(borrowed from spring)
 */
public interface PathMatcher {
	...
	/**
	 * Given a full path, returns a {@link java.util.Comparator} suitable for sorting patterns in order of explicitness for that path.
	 *
